...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.opacity = 0.85f;
        self.color = IWColor(193, 193, 193);
...
- (void)updateIndicators {
    ...
    BOOL isActivityIndicator = [indicator isKindOfClass:[UIImageView class]];
...
//        UIImage     *syncIcon = [UIImage imageNamed:@"loading_white.png"];
//        UIImageView *syncIconImage = [[UIImageView alloc] initWithImage:syncIcon];
//        [syncIconImage setFrame:CGRectMake(0, 0, syncIcon.size.width, syncIcon.size.height)];
//        self.indicator = syncIconImage;
//
//        CABasicAnimation *spinAnimation = [CABasicAnimation animationWithKeyPath:@"transform.rotation"];
//        spinAnimation.byValue = [NSNumber numberWithFloat:2 * M_PI];
//        spinAnimation.repeatCount = 50000;
//        spinAnimation.delegate = self;
//        spinAnimation.duration = 0.7f;
//        [self.indicator.layer addAnimation:spinAnimation forKey:@"startrefresh"];
...
- (void)drawRect:(CGRect)rect {
    ...
    // draw line border
    float radius = (rect.size.height / 2) - 2; // 2
